# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2018-09-25 17:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_preview_url', models.CharField(blank=True, max_length=500)),
                ('code', models.CharField(max_length=45, verbose_name='code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operation_number', models.CharField(max_length=12, verbose_name='operation number')),
                ('observations', models.CharField(max_length=255, null=True, verbose_name='observations')),
                ('authorization_date', models.DateTimeField(null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('status', models.PositiveIntegerField(choices=[(1, 'Pending'), (2, 'Accepted'), (3, 'Declined')], default=1)),
            ],
        ),
        migrations.CreateModel(
            name='PaymentType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('new_acquired_plan', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='api.QueryPlansAcquired')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('place', models.CharField(default='por definir', max_length=100)),
                ('total_amount', models.DecimalField(decimal_places=2, max_digits=10)),
                ('reference_number', models.CharField(max_length=20)),
                ('description', models.TextField()),
                ('is_fee', models.BooleanField(default=False)),
                ('status', models.PositiveIntegerField(choices=[(1, 'Unpaid'), (2, 'Progress'), (3, 'Paid')], default=1)),
            ],
        ),
        migrations.CreateModel(
            name='SaleDetail',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foreign_address', models.CharField(blank=True, max_length=250, null=True)),
        ...
        migrations.AddField(
            ...
            name='sale',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.Sale'),
        ),
        migrations.AddField(
            model_name='message',
            name='query',
