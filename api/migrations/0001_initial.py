# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-12-19 22:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ruc', models.CharField(blank=True, max_length=40, null=True, unique=True)),
                ...
                ('status', models.CharField(choices=[('0', 'Pending'), ('1', 'Activate'), ('2', 'Reject'), ('3', 'Deactivated')], default='0', max_length=1)),
            ],
            options={
                'abstract': False,
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cellphone', models.CharField(blank=True, max_length=14, null=True)),
                ('telephone', models.CharField(blank=True, max_length=14, null=True)),
                ('ocupation', models.CharField(blank=True, choices=[('0', 'Employer'), ('1', 'Independent worker'), ('2', 'Employee'), ('3', 'Worker'), ('4', 'Worker in a family business'), ('5', 'Home worker'), ('6', 'Other')], max_length=1)),
        ...
        migrations.AddField(
            model_name='product',
            name='seller',
            field=models.ManyToManyField(through='api.ProductsSellerNoBillable', to='api.Seller'),
        ),
        migrations.AddField(
            model_name='message',
            name='specialist',
