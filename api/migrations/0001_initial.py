# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-09-18 21:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='api.Answer')),
            ],
        ),
        migrations.CreateModel(
            name='Role',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commercial_group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='api.CommercialGroup')),
                ...
                ('profession', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='api.Profession')),
            ],
            options={
                'verbose_name': 'Client',
        ...
        migrations.AddField(
            model_name='query',
            name='precedent',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='api.Query'),
        ),
        migrations.AddField(
            model_name='fee',
            name='payment_type',
